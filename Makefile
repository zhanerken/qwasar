...
${OUTPUT}: main.o get_opt.o files_arg_handler.o free_opt.o ls_base.o _qsort.o set_files_list.o
	${CC} ${CC_OPT} main.o get_opt.o files_arg_handler.o free_opt.o ls_base.o _qsort.o set_files_list.o -o ${OUTPUT}
